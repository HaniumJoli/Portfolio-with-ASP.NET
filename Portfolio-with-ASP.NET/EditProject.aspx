<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditProject.aspx.cs" Inherits="Portfolio_with_ASP.NET.EditProject" %>
...
<div class="project-form">
    ...
    <div class="project-info">
        ...
        <asp:TextBox ID="ProjectNameBox" runat="server" CssClass="form-box" placeholder="New Project Name"></asp:TextBox>
    </div>

    <div class="project-info">

        <asp:TextBox ID="ProjectDetesBox" runat="server" CssClass="form-box" placeholder="New description"></asp:TextBox>
    </div>
    ...
    <asp:Button CssClass="btn-box form-btn" ID="AddProjectBtn" runat="server" Text="Confirm Edit" OnClick="EditProjectBtn_Click" />
